...
export const kitchenRequestCatalogDemo: CatalogMainCategory[] = [
  {
    id: 'meat',
    label: 'Мясо',
    icon: '🥩',
    description: 'Мясо и мясная гастрономия',
    subcategories: [
      {
        id: 'beef',
        label: 'Говядина',
  ...
  },
  {
    ...
    label: 'Рыба',
    icon: '🐟',
    description: 'Сюда позже добавим рыбу и морепродукты',
    subcategories: [],
  },
  {
    id: 'dairy',
    label: 'Молочка',
    icon: '🧀',
    description: 'Сюда позже добавим сыры, сливки и масло',
    subcategories: [],
  },
  {
    id: 'vegetables',
    label: 'Овощи',
    icon: '🥬',
    description: 'Сюда позже добавим овощи и зелень',
    subcategories: [],
  },
];
